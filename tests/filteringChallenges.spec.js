...
describe('Desafios sobre filtragem de dados', () => {
  ...
  describe('19. Quantos pedidos foram feitos na tabela `orders` pelo `employee_id` igual a 5 ou 6, e que foram enviados através do método `shipper_id` igual a 2? Chame a coluna de orders_count.', () => {
